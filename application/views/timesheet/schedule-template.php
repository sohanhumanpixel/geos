			...
			<div class="row panel-heading">
						...
						<table class="table table-bordered">
							...
							<?php if(!empty($bookingData)){
								...
								<tr class="unassigned_trs unassigned_trs_<?=$bookval->id;?>" data-id="<?=$bookval->id;?>">
									...
									<td><?php echo $bookval->pfrd_day;?></td>
									<td><?php echo $bookval->pfrd_time;?></td>
				...
				<div class="col-md-3">
					...
					<div class="text-center">
						<a href="javascript:void(0)" id="lockAll">Lock Schdeule</a>
					</div>
				</div>
					...
					<div class="table-responsive">
						...
						<table class="table table-striped text-center" border="1">
							 <tr class="table_heading border_bottom" height="24" style=''>
								  ...
								  <td class=""  style='width:30pt'>Tasks</td>
								...
								foreach($shhetData as $key => $sheetval){
									...
									if(!empty($sheetData)){
										...
										$td1_t4 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$todaydate.'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td2_t4 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[0].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td3_t4 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[1].'" data-empname="'.$fullname.'">Add</button></td>';
										
										
										$td4_t4 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[2].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td5_t4 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[3].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td1_t5 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$todaydate.'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td2_t5= '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[0].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td3_t5 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[1].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td4_t5 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[2].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td5_t5 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[3].'" data-empname="'.$fullname.'">Add</button></td>';

										$td1_t6 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$todaydate.'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td2_t6 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[0].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td3_t6 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[1].'" data-empname="'.$fullname.'">Add</button></td>';
										
										
										$td4_t6 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[2].'" data-empname="'.$fullname.'">Add</button></td>';
										
										$td5_t6 = '<td style="border-top:none;width:209pt"><button type="button" class="btn btn-info btn-sm openmodaltime" data-empid="'.$userData['userId'].'" data-ptypeid="'.$ptypeId.'" data-date="'.$weekOfdate[3].'" data-empname="'.$fullname.'">Add</button></td>';
										...
										$td1400 = $td1_1400.''.$td2_1400.''.$td3_1400.''.$td4_1400.''.$td5_1400;
										$tdt4 = $td1_t4.''.$td2_t4.''.$td3_t4.''.$td4_t4.''.$td5_t4;
										$tdt5 = $td1_t5.''.$td2_t5.''.$td3_t5.''.$td4_t5.''.$td5_t5;
										$tdt6 = $td1_t6.''.$td2_t6.''.$td3_t6.''.$td4_t6.''.$td5_t6;
									}else{	
                            ...
                            <td colspan="7" class="empcolp"><?php echo $userData['fname'].' '.$userData['lname']; 
	  ...
	  <form name="addtimesheet" id="addtimesheet" method="post">
		...
		<div class="md-form mb-5">
			...
			<div class="form-group site_div" >
				...
				<input type="text" name="site" class="form-control" id="site" disabled>
