						...
						<table class="table table-striped text-center" border="1">
							...
							foreach($ptypedata as $ptypeval){
								 ...
								 ?>
								  ...
								  <tr class="table_heading" height="24">
								  <td height="24" style='height:18.0pt'>&nbsp;</td>
								  <td  style='border-left:none'>&nbsp;</td>
								  <td  style='border-left:none'><?php echo $ptypeval->project_type_name; ?></td>
								  <td  style='border-left:none'>&nbsp;</td>
								  <td  style='border-left:none'>&nbsp;</td>
								  <td  style='border-left:none'>&nbsp;</td>
								  <td  style='border-left:none'>&nbsp;</td>
									...
									if(!empty($sheetData)){
										...
										$TodayFilter = $CI->filtersamedate($sheetData,$todaydate);
											...
											$hover_cont  = 'hover_container';
												$td1_700 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[0]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[0]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[0]['project_name'].'</h4><h4>Client:'.$TodayFilter[0]['client_name'].'</h4><h4>Contact:'.$TodayFilter[0]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[0]['instructions'].'</h4></div>">'.$TodayFilter[0]['instructions'].'</div></td>';
												break;
											case 2:
												$td1_700 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[0]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[0]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[0]['project_name'].'</h4><h4>Client:'.$TodayFilter[0]['client_name'].'</h4><h4>Contact:'.$TodayFilter[0]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[0]['instructions'].'</h4></div>">'.$TodayFilter[0]['instructions'].'</div></td>';
												$td1_1100 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[1]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[1]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[1]['project_name'].'</h4><h4>Client:'.$TodayFilter[1]['client_name'].'</h4><h4>Contact:'.$TodayFilter[1]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[1]['instructions'].'</h4></div>">'.$TodayFilter[1]['instructions'].'</div></td>';
												break;
											case 3:
											case 4:
											case 5:
											...
											case 7:
												$td1_700 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[0]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[0]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[0]['project_name'].'</h4><h4>Client:'.$TodayFilter[0]['client_name'].'</h4><h4>Contact:'.$TodayFilter[0]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[0]['instructions'].'</h4></div>">'.$TodayFilter[0]['instructions'].'</div></td>';
												$td1_1100 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[1]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[1]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[1]['project_name'].'</h4><h4>Client:'.$TodayFilter[1]['client_name'].'</h4><h4>Contact:'.$TodayFilter[1]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[1]['instructions'].'</h4></div>">'.$TodayFilter[1]['instructions'].'</div></td>';
												$td1_1400 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$TodayFilter[2]['job_number'].'</h4><h4>Booking Time:'.$TodayFilter[2]['schedule_date'].'</h4><h4>Site:'.$TodayFilter[2]['project_name'].'</h4><h4>Client:'.$TodayFilter[2]['client_name'].'</h4><h4>Contact:'.$TodayFilter[2]['project_address'].'</h4><h4>Instructions:'.$TodayFilter[2]['instructions'].'</h4></div>">'.$TodayFilter[2]['instructions'].'</div></td>';
												break;
											default:
										...
										$nextday1 = $CI->filtersamedate($sheetData,$weekOfdate[0]);
											...
											case 7:
												$td2_700 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$nextday1[0]['job_number'].'</h4><h4>Booking Time:'.$nextday1[0]['schedule_date'].'</h4><h4>Site:'.$nextday1[0]['project_name'].'</h4><h4>Client:'.$nextday1[0]['client_name'].'</h4><h4>Contact:'.$nextday1[0]['project_address'].'</h4><h4>Instructions:'.$nextday1[0]['instructions'].'</h4></div>">'.$nextday1[0]['instructions'].'</div></td>';
												$td2_1100 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$nextday1[1]['job_number'].'</h4><h4>Booking Time:'.$nextday1[1]['schedule_date'].'</h4><h4>Site:'.$nextday1[1]['project_name'].'</h4><h4>Client:'.$nextday1[1]['client_name'].'</h4><h4>Contact:'.$nextday1[1]['project_address'].'</h4><h4>Instructions:'.$nextday1[1]['instructions'].'</h4></div>">'.$nextday1[1]['instructions'].'</div></td>';
												$td2_1400 = '<td><div class="hover_popup" data-toggle="popover" data-trigger="hover" data-content="<div ><h4>Job Number:'.$nextday1[2]['job_number'].'</h4><h4>Booking Time:'.$nextday1[2]['schedule_date'].'</h4><h4>Site:'.$nextday1[2]['project_name'].'</h4><h4>Client:'.$nextday1[2]['client_name'].'</h4><h4>Contact:'.$nextday1[2]['project_address'].'</h4><h4>Instructions:'.$nextday1[2]['instructions'].'</h4></div>">'.$nextday1[2]['instructions'].'</div></td>';
												break;
											default:
