			...
			<div class="content-box-large">
				<div class="panel-heading">
					...
					<div class="panel-options">
					  <a href="<?=base_url()?>TaskList/sub/<?=$taskID?>" class="btn btn-success">Go Back</a>
					</div>
				</div>
                ...
                <div class="row">
					...
					<div class='col-md-9'>
					<form action="<?php echo base_url() ?>TaskList/subAddAction" name="adSubTask" id="adSubTask" method="post">
						<fieldset>
							<div class="form-group col-md-10">
								<label>Title<em>*</em></label>
								<input class="form-control" name="title" id="title" placeholder="Enter Subtask Title" type="text">
							</div>
							<div class="form-group col-md-2">
								<label>Abbreviation<em>*</em></label>
								<input class="form-control" name="abbr" id="abbr" placeholder="" type="text" maxlength="4">
							</div>
