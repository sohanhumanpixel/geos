	...
	<div class="col-md-10 padding-left-right">
			<div class="content-box-large">
                ...
                <div class="row">
					...
					<div class='col-md-9'>
					<form action="<?php echo base_url() ?>TaskList/addAction" name="adTask" id="adTask" method="post">
						<fieldset>
							<div class="form-group col-md-10">
								<label>Title<em>*</em></label>
								<input class="form-control" name="title" id="title" placeholder="Enter Task Title" type="text">
							</div>
